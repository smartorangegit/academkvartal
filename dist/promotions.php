...
<?php include_once('includes/gtm_body.php'); ?>
    ...
    <section>
        ...
        <div class="page-breadcrumbs">
            <div class="container">
                <span class="page-breadcrumbs__item"><a href="/">Головна</a></span>  //  <span class="page-breadcrumbs__item page-breadcrumbs__item_active">Акції</span>
            </div>
        </div>
        <div class="container promotions__alert">
            <img src="img/promotions/alert.png" alt="Alert">
        </div>
        <div class="container">
            <ul class="promotions__list">
                ...
                <li class="promotion">
                    <a href="#">
                        <div class="promotion__image promotion__image_4">
                        </div>
                        <div class="promotion__text">
                            <div class="promotion__heading">
                ...
                <li class="promotion">
                    <a href="#">
                        <div class="promotion__image promotion__image_5">
                        </div>
                        <div class="promotion__text">
                            <div class="promotion__heading">
                                СТАРТУЄ ПРОДАЖ НОВОГО ЖИТЛОВОГО КОМПЛЕКСУ «АКАДЕМ-КВАРТАЛ»
                ...
                <li class="promotion">
                    <a href="#">
                        <div class="promotion__image promotion__image_6">
                        </div>
                        <div class="promotion__text">
                            <div class="promotion__heading">
                            10% знижка першим покупцям! Стань одним із перших!
                ...
                <li class="promotion">
                    <a href="#">
                        <div class="promotion__image promotion__image_7">
                        </div>
                        <div class="promotion__text">
                            <div class="promotion__heading">
                            СТАРТУЄ ПРОДАЖ НОВОГО ЖИТЛОВОГО КОМПЛЕКСУ «АКАДЕМ-КВАРТАЛ»
                ...
                <li class="promotion">
                    <a href="#">
                        <div class="promotion__image promotion__image_8">
                        </div>
                        <div class="promotion__text">
                            <div class="promotion__heading">
                            10% знижка першим покупцям! Стань одним із перших!
