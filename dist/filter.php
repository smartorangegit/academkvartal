...
<body class="filter-body">
    ...
    <section>
        ...
        <div class="container">
            <div class="filter">
                <div class="filter-item filter-item__house">
                    <div class="filter-item__user">
                        <label class="fiter__label">Будинок:</label>
                        <input value="1" type="number" class="filter__input filter__input_min filter-item__house_min">
                        <input value="2" type="number" class="filter__input filter__input_max filter-item__house_max">
                    </div>
                    <input data-min="1" data-max="3" type="text" class="js-ion-range js-ion-range__house">
                </div>
                <div class="filter-item filter-item__floor">
                    <div class="filter-item__user">
                        <label class="fiter__label">Поверх:</label>
                        <input value="1" type="number" class="filter__input filter__input_min filter-item__floor_min">
                        <input value="24" type="number" class="filter__input filter__input_max filter-item__floor_max">
                    </div>
                    <input data-min="1" data-max="24" type="text" class="js-ion-range js-ion-range__floor">
                </div>
                <div class="filter-item filter-item__total-area">
                    <div class="filter-item__user">
                        <label class="fiter__label">Загальна лоща м2:</label>
                        <input value="44" type="number" class="filter__input filter__input_min filter-item__total-area_min">
                        <input value="172" type="number" class="filter__input filter__input_max filter-item__total-area_max">
                    </div>
                    <input data-min="44" data-max="172" type="text" class="js-ion-range js-ion-range__total-area">
                </div>
                <div class="filter-item filter-item__living-area">
                    <div class="filter-item__user">
                        <label class="fiter__label">Житлова лоща м2:</label>
                        <input value="12" type="number" class="filter__input filter__input_min filter-item__living-area_min">
                        <input value="154" type="number" class="filter__input filter__input_max filter-item__living-area_max">
                    </div>
                    <input data-min="12" data-max="154" type="text" class="js-ion-range js-ion-range__living-area">
                </div>
                <div class="filter-item filter-item__rooms">
                    <div class="filter-item__user">
                        <label class="fiter__label">К-сть Кімнат:</label>
                        <div class="filter__checkbox">
                            <input type="checkbox" id="filter__rooms_1">
                        ...
                        <div class="filter__checkbox">
                            <input type="checkbox" id="filter__rooms_2">
                        ...
                        <div class="filter__checkbox">
                            <input type="checkbox" id="filter__rooms_3">
