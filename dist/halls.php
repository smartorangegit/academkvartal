...
<body class="gallery">
    ...
    <section>
        ...
        <div class="page-breadcrumbs">
            <div class="container">
                <span class="page-breadcrumbs__item"><a href="/">Головна</a></span>  //  <span class="page-breadcrumbs__item page-breadcrumbs__item_active-blue">Холи</span>
            </div>
        </div>
        <div class="container">
            <div class="gallery__container animate">
                <div class="gallery__main js-gallery__main">
                    <div class="halls__main-item halls__main-item_1"></div>
                    <div class="halls__main-item halls__main-item_2"></div>
                    <div class="halls__main-item halls__main-item_3"></div>
                    <div class="halls__main-item halls__main-item_4"></div>
                    <div class="halls__main-item halls__main-item_5"></div>
                </div>
                ...
                <div class="gallery__nav-container">
                    <div class="gallery__nav js-gallery__nav">
                        <div class="halls__nav-item halls__nav-item_1"></div>
                        <div class="halls__nav-item halls__nav-item_2"></div>
                        <div class="halls__nav-item halls__nav-item_3"></div>
                        <div class="halls__nav-item halls__nav-item_4"></div>
                        <div class="halls__nav-item halls__nav-item_5"></div>
                    </div>
