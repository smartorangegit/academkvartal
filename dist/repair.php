...
<?php include_once('includes/gtm_body.php'); ?>
    ...
    <section>
        ...
        <div class="page-breadcrumbs">
            <div class="container">
                <span class="page-breadcrumbs__item"><a href="/">Головна</a></span>  //  <span class="page-breadcrumbs__item page-breadcrumbs__item_active-blue">Ремонти</span>
            </div>
        </div>
        <div class="container">
        <div class="repair__list">
               <div class="repair__item js-repair__item">
                    <div class="repair__repair repair__repair_1">
               ...
               <div class="repair__item js-repair__item">
                    <div class="repair__repair repair__repair_2">
                        <div class="repair__overlay">
                            Дивитися альбом
                        </div>
                    </div>
                ...
                <div class="repair__item js-repair__item">
                    <div class="repair__repair repair__repair_3">
                        <div class="repair__overlay">
                            Дивитися альбом
                        </div>
                    </div>
        ...
        <div class="repair__modal js-repair__modal">
            <div class="container">
                <div class="gallery__container">
                    ...
                    <div class="repair__gallery-close-btn js-repair__gallery-close-btn">
